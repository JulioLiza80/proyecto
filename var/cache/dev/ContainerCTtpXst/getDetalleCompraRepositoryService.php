 ...
 */
class getDetalleCompraRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DetalleCompraRepository' shared autowired service.
     *
     * @return \App\Repository\DetalleCompraRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DetalleCompraRepository.php';

        return $container->privates['App\\Repository\\DetalleCompraRepository'] = new \App\Repository\DetalleCompraRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
