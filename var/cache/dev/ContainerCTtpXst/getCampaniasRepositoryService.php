 ...
 */
class getCampaniasRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CampaniasRepository' shared autowired service.
     *
     * @return \App\Repository\CampaniasRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CampaniasRepository.php';

        return $container->privates['App\\Repository\\CampaniasRepository'] = new \App\Repository\CampaniasRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
