 ...
 */
class getLentillasRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LentillasRepository' shared autowired service.
     *
     * @return \App\Repository\LentillasRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LentillasRepository.php';

        return $container->privates['App\\Repository\\LentillasRepository'] = new \App\Repository\LentillasRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
