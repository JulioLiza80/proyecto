 ...
 */
class getDetallePedidoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DetallePedidoRepository' shared autowired service.
     *
     * @return \App\Repository\DetallePedidoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DetallePedidoRepository.php';

        return $container->privates['App\\Repository\\DetallePedidoRepository'] = new \App\Repository\DetallePedidoRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
