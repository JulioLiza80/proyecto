 ...
 */
class getVichUploader_Listener_Remove_CampaniaService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.campania' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.campania'])) {
            return $container->privates['vich_uploader.listener.remove.campania'];
        }

        return $container->privates['vich_uploader.listener.remove.campania'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('campania', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
