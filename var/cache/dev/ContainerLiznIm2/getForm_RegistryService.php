...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\CampaniasType' => ['privates', 'App\\Form\\CampaniasType', 'getCampaniasTypeService', true],
            'App\\Form\\ChangePasswordFormType' => ['privates', 'App\\Form\\ChangePasswordFormType', 'getChangePasswordFormTypeService', true],
            'App\\Form\\DetalleCompraType' => ['privates', 'App\\Form\\DetalleCompraType', 'getDetalleCompraTypeService', true],
            'App\\Form\\DetallePedidoType' => ['privates', 'App\\Form\\DetallePedidoType', 'getDetallePedidoTypeService', true],
            'App\\Form\\GafasType' => ['privates', 'App\\Form\\GafasType', 'getGafasTypeService', true],
            'App\\Form\\LentillasType' => ['privates', 'App\\Form\\LentillasType', 'getLentillasTypeService', true],
            'App\\Form\\PedidosType' => ['privates', 'App\\Form\\PedidosType', 'getPedidosTypeService', true],
            ...
            'App\\Form\\CampaniasType' => '?',
            'App\\Form\\ChangePasswordFormType' => '?',
            'App\\Form\\DetalleCompraType' => '?',
            'App\\Form\\DetallePedidoType' => '?',
            'App\\Form\\GafasType' => '?',
            'App\\Form\\LentillasType' => '?',
            'App\\Form\\PedidosType' => '?',
