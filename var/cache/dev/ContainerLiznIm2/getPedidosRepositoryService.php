 ...
 */
class getPedidosRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PedidosRepository' shared autowired service.
     *
     * @return \App\Repository\PedidosRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PedidosRepository.php';

        return $container->privates['App\\Repository\\PedidosRepository'] = new \App\Repository\PedidosRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
