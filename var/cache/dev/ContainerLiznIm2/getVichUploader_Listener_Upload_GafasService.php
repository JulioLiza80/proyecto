 ...
 */
class getVichUploader_Listener_Upload_GafasService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.gafas' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.gafas'])) {
            return $container->privates['vich_uploader.listener.upload.gafas'];
        }

        return $container->privates['vich_uploader.listener.upload.gafas'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('gafas', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
