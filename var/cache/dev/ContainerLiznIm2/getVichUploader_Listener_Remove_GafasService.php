 ...
 */
class getVichUploader_Listener_Remove_GafasService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.gafas' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.gafas'])) {
            return $container->privates['vich_uploader.listener.remove.gafas'];
        }

        return $container->privates['vich_uploader.listener.remove.gafas'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('gafas', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
