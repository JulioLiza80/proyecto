 ...
 */
class getVichUploader_Listener_Upload_LentillasService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.lentillas' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.lentillas'])) {
            return $container->privates['vich_uploader.listener.upload.lentillas'];
        }

        return $container->privates['vich_uploader.listener.upload.lentillas'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('lentillas', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
