 ...
 */
class getVichUploader_Listener_Remove_UserService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.user' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.user'])) {
            return $container->privates['vich_uploader.listener.remove.user'];
        }

        return $container->privates['vich_uploader.listener.remove.user'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('user', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
