 ...
 */
class getGafasRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GafasRepository' shared autowired service.
     *
     * @return \App\Repository\GafasRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GafasRepository.php';

        return $container->privates['App\\Repository\\GafasRepository'] = new \App\Repository\GafasRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
