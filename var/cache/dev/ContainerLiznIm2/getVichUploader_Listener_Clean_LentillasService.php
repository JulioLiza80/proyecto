 ...
 */
class getVichUploader_Listener_Clean_LentillasService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.lentillas' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.lentillas'])) {
            return $container->privates['vich_uploader.listener.clean.lentillas'];
        }

        return $container->privates['vich_uploader.listener.clean.lentillas'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('lentillas', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
