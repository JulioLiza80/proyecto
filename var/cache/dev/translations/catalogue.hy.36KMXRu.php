...
$catalogue = new MessageCatalogue('hy', array (
  ...
  'EasyAdminBundle' => 
  array (
    'page_title.dashboard' => 'Վահանակ',
    'page_title.detail' => '%entity_label_singular% <small>(#%entity_short_id%)</small>',
    'page_title.edit' => '%entity_label_singular%',
    'page_title.index' => '%entity_label_plural%',
    'page_title.new' => 'Ստեղծել նոր %entity_label_singular%',
    'page_title.exception' => 'Սխալ|Սխալներ|Սխալիկ',
    'datagrid.hidden_results' => 'Որոշակի արդյունքները չեն կարող ցուցադրվել, քանի որ Դուք չունեք պահանջվող իրավասությունները',
    'datagrid.no_results' => 'Ոչինչ չի գտնվել։',
    'paginator.first' => 'Առաջին',
    'paginator.previous' => 'Նախորդ',
    'paginator.next' => 'Հաջորդ',
    'paginator.last' => 'Վերջին',
    'paginator.counter' => '<strong>%start%</strong> - <strong>%end%</strong> ից <strong>%results%</strong>',
    'paginator.results' => '<strong>%count%</strong> արդյունք|<strong>%count%</strong> արդյունք|<strong>%count%</strong> արդյունքներ',
    'label.true' => 'Այո',
    'label.false' => 'Ոչ',
    'label.empty' => 'Դատարկ',
    'label.null' => 'Null',
    'label.object' => 'PHP-օբյեկտ',
    'label.inaccessible' => 'Անհասանելի է',
    'label.inaccessible.explanation' => 'Այս դաշտի համար չկա կատարողը, կամ հատկանիշները հասանելի չեն',
    'label.form.empty_value' => 'Դատարկ է',
    'field.code_editor.view_code' => 'Տեսնել կոդը',
    'field.text_editor.view_content' => 'Տեսնել պարունակությունը',
    'action.entity_actions' => 'Գործողություն',
    'action.new' => 'Ստեղծել %entity_label_singular%',
    'action.search' => 'Որոնել',
    'action.detail' => 'Մանրամասն',
    'action.edit' => 'Խմբագրել',
    'action.delete' => 'Հեռացնել',
    'action.cancel' => 'Չեղարկել',
    'action.index' => 'Վերադառնալ ցուցակին',
    'action.deselect' => 'Հանել ընտրությունը',
    'action.add_new_item' => 'Ավելացնել նոր տարր',
    'action.remove_item' => 'Հեռացնել տարրը',
    'action.choose_file' => 'Ընտրել ֆայլը',
    'action.close' => 'Փակել',
    'action.create' => 'Ստեղծել',
    'action.create_and_add_another' => 'Ստեղծել և նորը ավելացնել',
    'action.create_and_continue' => 'Ստեղծել և շարունակել',
    'action.save' => 'Պահպանել',
    'action.save_and_continue' => 'Պահպանել և շարունակել',
    'batch_action_modal.title' => 'Դուք պատրաստվում եք կատարել "%action_name%" գործողությունը %num_items% ընտրված տողերի համար',
    'batch_action_modal.content' => 'Այս գործողությունը չի կարող չեղարկվել.',
    'batch_action_modal.action' => 'Շարունակել',
    'delete_modal.title' => 'Խնդրում ենք հաստատել, Դուք իրոք ցանկանում եք հեռացնել',
    'delete_modal.content' => 'Այս գործողությունը չի կարող չեղարկվել։',
    'filter.title' => 'Ֆիլտրեր',
    'filter.button.clear' => 'Մաքրել',
    'filter.button.apply' => 'Կիրառել',
    'filter.label.is_equal_to' => 'հավասար է',
    'filter.label.is_not_equal_to' => 'հավասար չէ',
    'filter.label.is_greater_than' => 'մեծ է',
    'filter.label.is_greater_than_or_equal_to' => 'մեծ է կամ հավասար է',
    'filter.label.is_less_than' => 'փոքր է',
    'filter.label.is_less_than_or_equal_to' => 'փոքր է կամ հավասար է',
    'filter.label.is_between' => 'միջակայքում է',
    'filter.label.contains' => 'պարունակում է',
    'filter.label.not_contains' => 'չի պարունակում',
    'filter.label.starts_with' => 'սկսվում է',
    'filter.label.ends_with' => 'ավարտվում է',
    'filter.label.exactly' => 'ստույգ տեքստով',
    'filter.label.not_exactly' => 'ոչ ստույգ',
    'filter.label.is_same' => 'նույնն է',
    'filter.label.is_not_same' => 'տարբեր է',
    'filter.label.is_after' => 'հետո',
    'filter.label.is_after_or_same' => 'հետո կամ նույնը է',
    'filter.label.is_before' => 'առաջ',
    'filter.label.is_before_or_same' => 'առաջ կամ նույնը է',
    'form.are_you_sure' => 'Դուք չեք հիշել կատարված փոփոխությունները',
    'form.tab.error_badge_title' => 'Մեկ անհաջող փորձ|%count% անհաջող փորձեր|%count% անհաջող փորձերից',
    'form.slug.confirm_text' => 'Եթե փոխեք տեքստի իդենտիֆիկատորը, կարող եք խափանել այլ էջերում գտնվող հղումները.',
    'user.logged_in_as' => 'Դուք մուտք եք գործել որպես',
    'user.unnamed' => 'Անանուն օգտվող',
    'user.anonymous' => 'Անանուն օգտվող',
    'user.sign_out' => 'Ելք',
    'user.exit_impersonation' => 'Դուրս գալ',
    'settings.appearance.label' => 'Արտաքին ձևավորում',
    'settings.appearance.light' => 'Լուսավոր',
    'settings.appearance.dark' => 'Մութ',
    'settings.appearance.auto' => 'Ավտոմատ',
    'settings.locale' => 'Լեզու',
    'login_page.username' => 'Օգտանուն',
    'login_page.password' => 'Գաղտնաբառ',
    'login_page.sign_in' => 'Մուտք',
    'login_page.forgot_password' => 'Մոռացե՞լ եք գաղտնաբառը',
    'login_page.remember_me' => 'Հիշիր ինձ',
    'exception.entity_not_found' => 'Տարրն այլևս հասանելի չէ։',
    'exception.entity_remove' => 'Տարրը չի կարող հեռացվել, քանի որ մեկ այլ տարր կախված է դրանից։',
    'exception.forbidden_action' => 'Պահանջվող գործողությունը չի թույլատրվում։',
    'exception.insufficient_entity_permission' => 'Դուք չունեք բավարար թույլտվություններ։',
    'autocomplete.no-results-found' => 'Համընկնումներ չեն գտնվել',
    'autocomplete.loading-more-results' => 'Տվյալների բեռնում…',
  ),
));
