...
$catalogue = new MessageCatalogue('zh_TW', array (
  ...
  array (
    ...
    'This URL is missing a top-level domain.' => '此URL缺少頂級域名。',
  ...
  'EasyAdminBundle' => 
  array (
    'page_title.dashboard' => '儀表板',
    'page_title.detail' => '%entity_label_singular% <small>(#%entity_short_id%)</small>',
    'page_title.edit' => '編輯%entity_label_singular%',
    'page_title.index' => '%entity_label_plural%',
    'page_title.new' => '建立%entity_label_singular%',
    'page_title.exception' => '錯誤|錯誤',
    'datagrid.hidden_results' => '由於權限不足，部分結果無法顯示',
    'datagrid.no_results' => '未找到結果。',
    'paginator.first' => '第一頁',
    'paginator.previous' => '上一頁',
    'paginator.next' => '下一頁',
    'paginator.last' => '最後一頁',
    'paginator.counter' => '<strong>%start%</strong> – <strong>%end%</strong> 共 <strong>%results%</strong> 個',
    'paginator.results' => '{0} 無結果|{1} <strong>1</strong> 個結果|]1,Inf] <strong>%count%</strong> 個結果',
    'label.true' => '是',
    'label.false' => '否',
    'label.empty' => '空',
    'label.null' => 'Null',
    'label.object' => 'PHP 物件',
    'label.inaccessible' => '無法存取',
    'label.inaccessible.explanation' => '此欄位的 Getter 方法不存在或欄位不是 public',
    'label.form.empty_value' => '無',
    'field.code_editor.view_code' => '檢視程式碼',
    'field.text_editor.view_content' => '檢視內容',
    'action.entity_actions' => '動作',
    ...
    'action.add_new_item' => '新增項目',
    'action.remove_item' => '移除項目',
    'action.choose_file' => '選擇檔案',
    'action.close' => '關閉',
    'action.create' => '建立',
    'action.create_and_add_another' => '建立並繼續新增',
    'action.create_and_continue' => '建立並繼續編輯',
    'action.save' => '儲存更改',
    'action.save_and_continue' => '儲存並繼續編輯',
    'batch_action_modal.title' => '您即將對 %num_items% 個項目執行「%action_name%」動作。',
    'batch_action_modal.content' => '此動作無法復原。',
    'batch_action_modal.action' => '繼續',
    'delete_modal.title' => '您確定要刪除此項目嗎？',
    'delete_modal.content' => '此動作無法復原。',
    'filter.title' => '篩選器',
    'filter.button.clear' => '清除',
    'filter.button.apply' => '套用',
    'filter.label.is_equal_to' => '等於',
    'filter.label.is_not_equal_to' => '不等於',
    'filter.label.is_greater_than' => '大於',
    'filter.label.is_greater_than_or_equal_to' => '大於或等於',
    'filter.label.is_less_than' => '小於',
    'filter.label.is_less_than_or_equal_to' => '小於或等於',
    'filter.label.is_between' => '處於範圍',
    'filter.label.contains' => '包含',
    'filter.label.not_contains' => '不包含',
    'filter.label.starts_with' => '開始於',
    'filter.label.ends_with' => '結尾於',
    'filter.label.exactly' => '完全等於',
    'filter.label.not_exactly' => '不完全等於',
    'filter.label.is_same' => '相同',
    'filter.label.is_not_same' => '不相同',
    'filter.label.is_after' => '之後於',
    'filter.label.is_after_or_same' => '之後或相同於',
    'filter.label.is_before' => '之前於',
    'filter.label.is_before_or_same' => '之前或相同於',
    'form.are_you_sure' => '您尚未儲存此表單上的更動。',
    'form.tab.error_badge_title' => '1 個無效輸入|%count% 個無效輸入',
    'form.slug.confirm_text' => '如果您更改了 slug，其他頁面的連結可能會失效。',
    'user.logged_in_as' => '登入身分',
    'user.unnamed' => '未命名使用者',
    'user.anonymous' => '匿名使用者',
    'user.sign_out' => '登出',
    'user.exit_impersonation' => '離開使用者模擬',
    'settings.appearance.label' => '外觀',
    'settings.appearance.light' => '亮色',
    'settings.appearance.dark' => '暗色',
    'settings.appearance.auto' => '自動',
    'settings.locale' => '語言',
    'login_page.username' => '使用者名稱',
    'login_page.password' => '密碼',
    'login_page.sign_in' => '登入',
    'login_page.forgot_password' => '忘記密碼？',
    'login_page.remember_me' => '記住我',
    'exception.entity_not_found' => '此項目已不能取用。',
    'exception.entity_remove' => '由於其他項目依賴於此項目，因此無法刪除。',
    'exception.forbidden_action' => '無法對此項目執行請求的動作。',
    'exception.insufficient_entity_permission' => '您無權取用此項目。',
    'autocomplete.no-results-found' => '未找到結果',
    'autocomplete.no-more-results' => '沒有更多結果',
    'autocomplete.loading-more-results' => '正在載入更多結果⋯⋯',
  ),
));
