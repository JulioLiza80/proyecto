...
$cataloguePt = new MessageCatalogue('pt', array (
  ...
  'EasyAdminBundle' => 
  array (
    'page_title.dashboard' => 'Painel de Controlo',
    'page_title.detail' => '%entity_label_singular% <small>(#%entity_short_id%)</small>',
    'page_title.edit' => 'Editar %entity_label_singular%',
    'page_title.index' => '%entity_label_plural%',
    'page_title.new' => 'Criar %entity_label_singular%',
    'page_title.exception' => 'Erro|Erros',
    'datagrid.hidden_results' => 'Alguns resultados não podem ser exibidos porque não tem permissões suficientes',
    'datagrid.no_results' => 'Nenhum resultado encontrado.',
    ...
    'field.text_editor.view_content' => 'Ver conteúdo',
    'action.entity_actions' => 'Ações',
    'action.new' => 'Adicionar %entity_label_singular%',
    'action.search' => 'Pesquisar',
    'action.detail' => 'Mostrar',
    'action.edit' => 'Editar',
    'action.delete' => 'Excluir',
    'action.cancel' => 'Cancelar',
    'action.index' => 'Voltar à listagem',
    'action.deselect' => 'Desmarcar',
    'action.add_new_item' => 'Adicionar novo item',
    'action.remove_item' => 'Remover item',
    'action.choose_file' => 'Escolher arquivo',
    'action.close' => 'Fechar',
    'action.create' => 'Criar',
    'action.create_and_add_another' => 'Criar e adicionar outro',
    'action.create_and_continue' => 'Criar e continuar a editar',
    'action.save' => 'Guardar alterações',
    'action.save_and_continue' => 'Guardar e continuar a editar',
    'batch_action_modal.title' => 'Vai aplicar a ação "%action_name%" a %num_items% item(s).',
    'batch_action_modal.content' => 'Esta operação é irreversível.',
    'batch_action_modal.action' => 'Proceder',
    'delete_modal.title' => 'Tem a certeza que deseja excluir este item?',
    'delete_modal.content' => 'Esta operação é irreversível.',
    'filter.title' => 'Filtros',
    'filter.button.clear' => 'Limpar',
    'filter.button.apply' => 'Aplicar',
    'filter.label.is_equal_to' => 'é igual a',
    ...
    'filter.label.is_less_than' => 'é menor que',
    'filter.label.is_less_than_or_equal_to' => 'é menor ou igual a',
    'filter.label.is_between' => 'é entre',
    'filter.label.contains' => 'contém',
    'filter.label.not_contains' => 'não contém',
    'filter.label.starts_with' => 'começa com',
    'filter.label.ends_with' => 'termina com',
    'filter.label.exactly' => 'exatamente',
    'filter.label.not_exactly' => 'não exatamente',
    'filter.label.is_same' => 'é o mesmo',
    'filter.label.is_not_same' => 'não é o mesmo',
    'filter.label.is_after' => 'é depois',
    'filter.label.is_after_or_same' => 'é depois ou igual',
    'filter.label.is_before' => 'é antes',
    'filter.label.is_before_or_same' => 'é antes ou igual',
    'form.are_you_sure' => 'Não guardou as alterações feitas neste formulário.',
    'form.tab.error_badge_title' => 'Uma entrada inválida|%count% entradas inválidas',
    'form.slug.confirm_text' => 'Se alterar o slug, pode quebrar links em outras páginas.',
    'user.logged_in_as' => 'Autenticado como',
    'user.unnamed' => 'Utilizador sem nome',
    'user.anonymous' => 'Utilizador anónimo',
    'user.sign_out' => 'Terminar sessão',
    'user.exit_impersonation' => 'Sair da personificação',
    'settings.appearance.label' => 'Definições de aparência',
    'settings.appearance.light' => 'Claro',
    'settings.appearance.dark' => 'Escuro',
    'settings.appearance.auto' => 'Automático',
    'settings.locale' => 'Configurações de idioma',
    'login_page.username' => 'Nome de utilizador',
    'login_page.password' => 'Palavra-passe',
    'login_page.sign_in' => 'Entrar',
    'login_page.forgot_password' => 'Esqueceu a palavra-passe?',
    'login_page.remember_me' => 'Lembrar de mim',
    'exception.entity_not_found' => 'Este item já não está disponível.',
    'exception.entity_remove' => 'Este item não pode ser excluído porque outros itens dependem dele.',
    'exception.forbidden_action' => 'A ação solicitada não pode ser realizada neste item.',
    'exception.insufficient_entity_permission' => 'Não tem permissão para aceder a este item.',
    'autocomplete.no-results-found' => 'Nenhum resultado encontrado',
    'autocomplete.no-more-results' => 'Não há mais resultados',
