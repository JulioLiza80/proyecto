...
$catalogue = new MessageCatalogue('sr_Cyrl', array (
  ...
  array (
    ...
    'This is not a valid Business Identifier Code (BIC).' => 'Ова вредност није валидна Код за идентификацију бизниса (BIC).',
    'Error' => 'Грешка',
    ...
    'This URL is missing a top-level domain.' => 'Овом УРЛ-у недостаје домен највишег нивоа.',
    'This value is too short. It should contain at least one word.|This value is too short. It should contain at least {{ min }} words.' => 'Ова вредност је прекратка. Треба да садржи макар једну реч.|Ова вредност је прекратка. Треба да садржи макар {{ min }} речи.',
    'This value is too long. It should contain one word.|This value is too long. It should contain {{ max }} words or less.' => 'Ова вредност је предугачка. Треба да садржи само једну реч.|Ова вредност је предугачка. Треба да садржи највише {{ max }} речи.',
    ...
    'This value should not be before week "{{ min }}".' => 'Ова вредност не би требала да буде пре недеље "{{ min }}".',
    'This value should not be after week "{{ max }}".' => 'Ова вредност не би требала да буде после недеље "{{ max }}".',
