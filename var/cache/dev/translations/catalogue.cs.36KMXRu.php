...
$catalogue = new MessageCatalogue('cs', array (
  ...
  array (
    ...
    'datagrid.hidden_results' => 'Některé položky nemohly být zobrazeny neboť nemáte patřičná oprávnění',
    ...
    'paginator.results' => '{0} Žádná položka|{1} <strong>1</strong> položka|{2,3,4} <strong>%count%</strong> položky|[5,Inf] <strong>%count%</strong> položek',
    'label.true' => 'Ano',
    'label.false' => 'Ne',
    'label.empty' => 'Prázdné',
    'label.null' => 'Nulové',
    ...
    'label.inaccessible.explanation' => 'Getter metoda pro toto pole neexistuje nebo není veřejná',
    ...
    'batch_action_modal.title' => 'Opravdu chcete upravit vybrané položky?',
    ...
    'filter.label.is_same' => 'je stejné',
    'filter.label.is_not_same' => 'není stejné',
    ...
    'exception.forbidden_action' => 'Na této položce nemůže být provedena požadovaná akce.',
    ...
    'autocomplete.no-more-results' => 'Žádné další položky',
    'autocomplete.loading-more-results' => 'Načítají se další položky…',
  ),
));
