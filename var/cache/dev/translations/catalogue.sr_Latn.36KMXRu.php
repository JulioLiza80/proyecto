...
$catalogue = new MessageCatalogue('sr_Latn', array (
  ...
  array (
    ...
    'No temporary folder was configured in php.ini.' => 'Privremeni direktorijum nije konfigurisan u php.ini, ili direktorijum koji je konfigurisan ne postoji.',
    ...
    'This value is too short. It should contain at least one word.|This value is too short. It should contain at least {{ min }} words.' => 'Ova vrednost je prekratka. Treba da sadrži makar jednu reč.|Ova vrednost je prekratka. Treba da sadrži makar {{ min }} reči.',
    'This value is too long. It should contain one word.|This value is too long. It should contain {{ max }} words or less.' => 'Ova vrednost je predugačka. Treba da sadrži samo jednu reč.|Ova vrednost je predugačka. Treba da sadrži najviše {{ max }} reči.',
    ...
    'This value should not be before week "{{ min }}".' => 'Ova vrednost ne bi trebala da bude pre nedelje "{{ min }}".',
    'This value should not be after week "{{ max }}".' => 'Ova vrednost ne bi trebala da bude posle nedelje "{{ max }}".',
